                    ...
                    <div class="panel-body">
                        @if($urun_gunun_firsati)
                            <a href="{{route('urun',$urun_gunun_firsati->slug)}}">
                                <img src="{{ $urun_gunun_firsati->getUrunDetay->urun_resfi != null ? asset('/urun-resimleri/urunler/'.$urun_gunun_firsati->getUrunDetay->urun_resmi) : 'https://via.placeholder.com/400x430?text=Resim Bulunamadı' }}"
