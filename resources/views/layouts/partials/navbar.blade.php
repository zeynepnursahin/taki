    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('anasayfa')}}">
               <img src="/img/sitelogo.png" width="200" height="300">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                        {{auth()->user()->adsoyad}} <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        ...
                        <form action="{{route('kullanici.oturumukapat')}}" id="logout-form" method="post" style="display: none">
                            @csrf
                        </form>
                    </ul>
                </li>
